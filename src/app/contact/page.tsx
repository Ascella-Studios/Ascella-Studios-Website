...
const contactInfo = [
  ...
  },
  {
    ...
    content: <p className="text-foreground/70">Watertown, WI</p>,
  },
  {
    label: 'Response Time',
    icon: (
    ...
    content: <p className="text-foreground/70">Usually within 24 hours</p>,
  },
];
...
export default function ContactPage() {
  return (
    <div className="bg-background relative overflow-hidden py-16 sm:py-24">
            ...
            <div className="space-y-6">
              {contactInfo.map((item) => (
                <div key={item.label} className="flex items-start gap-4">
                  <div className="size-10 rounded-lg border border-border bg-card text-sky flex items-center justify-center flex-shrink-0">
                    {item.icon}
                  </div>
                  <div>
              ...
              <div className="flex gap-3">
                {socialLinks.map((item) => (
                  <a
                    ...
                    className="w-11 h-11 rounded-lg border border-border bg-card flex items-center justify-center text-foreground/70 hover:text-sky hover:border-sky/50 transition-colors"
